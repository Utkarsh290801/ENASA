...
/* Color edit */
.dxcpColorAreaSys {
	background-image: url('/DXR.axd?r=1_178-tnTwn');
	position: relative;
	width: 290px;
	height: 240px;
	overflow: hidden;
...
.dxcpHueAreaImageSys {
	background-image: url('/DXR.axd?r=1_180-tnTwn');
	position: absolute;
	left: 6px;
	width: 21px;
    height: 240px;
...
.dxcpColorPointerSys {
	background-image: url('/DXR.axd?r=1_179-tnTwn');
	position: absolute;
	width: 11px;
	height: 11px;
}
.dxcpHuePointerSys {
	background-image: url('/DXR.axd?r=1_181-tnTwn');
	position: absolute;
	width: 35px;
	height: 9px;
}
...
{
    background-image: url('/DXR.axd?r=0_772-rnTwn');
}
.dxeTBVSys .dxeTBTrack_DevEx
{
    background-image: url('/DXR.axd?r=0_773-rnTwn');
}
.dxeTBHSys .dxeTBTrack_DevEx,
...
.dxeTBHSys .dxeTBBarHighlight_DevEx
{
    background-image: url('/DXR.axd?r=0_762-rnTwn');
}
.dxeTBVSys .dxeTBBarHighlight_DevEx
{
    background-image: url('/DXR.axd?r=0_763-rnTwn');
}
.dxeTBRBLabel_DevEx,
.dxeTBLTLabel_DevEx
{
...
{
    background-image: url('/DXR.axd?r=0_768-rnTwn');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBItem_DevEx
{
    background-image: url('/DXR.axd?r=0_766-rnTwn');
}
.dxeTBVSys .dxeTBItem_DevEx
{
    background-image: url('/DXR.axd?r=0_769-rnTwn');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBItem_DevEx
{
    background-image: url('/DXR.axd?r=0_767-rnTwn');
}
...
{
    background-image: url('/DXR.axd?r=0_770-rnTwn');
}
.dxeTBVSys .dxeTBSmallTick_DevEx
{
    background-image: url('/DXR.axd?r=0_771-rnTwn');
}
.dxeTBHSys .dxeTBBScaleSys .dxeTBLargeTick_DevEx
{
    background-image: url('/DXR.axd?r=0_764-rnTwn');
}
.dxeTBVSys .dxeTBBScaleSys .dxeTBLargeTick_DevEx
{
    background-image: url('/DXR.axd?r=0_765-rnTwn');
}
...
.dxeColorEditButton_DevEx
{
    background: #ebedf2 url('/DXR.axd?r=0_753-rnTwn') repeat-x left top;
...
.dxeColorEditButton_DevEx:active
{
    color: #3c3c3c;
    border-color: #9da0aa;
    background: #dbdde2 url('/DXR.axd?r=0_756-rnTwn') repeat-x left top;
}
...
{
    background: #e3e5e8 url('/DXR.axd?r=0_758-rnTwn') repeat-x left top;
}
/* -- Hover -- */
...
.dxeColorEditButton_DevEx:hover
{
    background: #dde6fe url('/DXR.axd?r=0_755-rnTwn') repeat-x left top;
}
...
{
    background: #e6edfe url('/DXR.axd?r=0_757-rnTwn') repeat-x left top;
}
.dxeButtonEdit_DevEx
{
    background-color: white;
...
{
    background: #f3f3f4 url('/DXR.axd?r=0_774-rnTwn') repeat-x left top;
...
{
    border-color: #e1e2e5;
    background: #f8f9fa url('/DXR.axd?r=0_754-rnTwn') repeat-x left top;
}
.dxbDisabled_DevEx,
...
{
    background: #f3f4f5 url('/DXR.axd?r=0_759-rnTwn') repeat-x left top;
...
{
    background: #edd0f4 url('/DXR.axd?r=0_760-rnTwn') repeat-x left top;
}
/* -- DropDownWindow -- */
.dxpcDropDown_DevEx,
...
.dxeACICellSelected_DevEx
{
    ...
    background: #e9eaee url('/DXR.axd?r=0_891-rnTwn') repeat-x left top;
    border: 1px solid #9da0aa;
}
...
{
    padding: 2px !important;
    background: #e3ebff url('/DXR.axd?r=0_894-rnTwn') repeat-x left top;
...
.dxeToken_DevEx
{
    background: #f4f4f4 url('/DXR.axd?r=0_761-rnTwn') repeat-x top;
}
...
{
    background-image: url('/DXR.axd?r=0_886-rnTwn');
    height: 32px;
    width: 32px;
}
